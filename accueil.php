...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
    <div>
      <h3 class="float-md-start mb-0">Neige et Soleil</h3>
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link active" aria-current="page" href="#">Accueil</a>
        <a class="nav-link" href="index.php?page=2&auth=1">Inscription</a>
        <a class="nav-link" href="index.php?page=2&auth=0">Connexion</a>
      </nav>
    </div>
  </header>
  ...
  <footer class="mt-auto text-white-50">
    <p>Creer par FBA WEB (Fofana Benrais Aziz)</p>
  </footer>
</div>
